...
const fruits = [
  ...
  console.log("2. Jumlah wadah dan buah di masing-masing wadah:", getContainers());
  console.log("3. Total stock buah di masing-masing wadah:", getTotalStockPerContainer());
